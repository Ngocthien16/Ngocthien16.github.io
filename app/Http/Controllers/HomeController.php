...
class HomeController extends Controller
{
    ...
    public function index(Request $request){
        ...
        //seo 
        $meta_desc = "Chuyên bán những dụng cụ, vật liệu xây dựng"; 
        $meta_keywords = "dung cu xay dung,vat lieu xay dung,dung cu xay dung ben, vat lieu gia re";
        $meta_title = "Dụng cụ, vật liệu xây dựng chính hãng";
