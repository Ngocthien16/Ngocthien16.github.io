...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> 0379079379</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> Shopvatlieu.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="companyinfo">
                            <h2><span>Shop</span>-vatlieu</h2>
                            <p>Chuyên cung cấp các dụng cụ xây dựng cao cấp nhập khẩu và vật liệu xây dựng tại Hồ Chí Minh.</p>
                        </div>
                    </div>
                    <div class="col-sm-7">
                        <div class="col-sm-3">
    ...
    <script>
      ...
      paypal.Button.render({
        ...
        env: 'sandbox',
        client: {
          sandbox: 'AXQopQ8n0g9alcC169TqsK9K2CJ3DbhDWGndofTZKTogoEENhfCeFmkdKSqHf_9fFciuFfy2IaBr0aQk',
